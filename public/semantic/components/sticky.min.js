!(function (T, w, B, P) {
  'use strict'
  ;(w =
    void 0 !== w && w.Math == Math
      ? w
      : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()),
    (T.fn.sticky = function (b) {
      var v,
        e = T(this),
        x = e.selector || '',
        S = new Date().getTime(),
      ...
      return (
        e.each(function () {
          var n,
            ...
            t,
            m = T.isPlainObject(b)
              ? T.extend(!0, {}, T.fn.sticky.settings, b)
            ...
            p = {
              initialize: function () {
                p.determineContainer(),
                  p.determineContext(),
                  p.verbose('Initializing sticky', m, n),
                  p.save.positions(),
                  p.checkErrors(),
                  p.bind.events(),
                  m.observeChanges && p.observeChanges(),
                  p.instantiate()
              },
              instantiate: function () {
                p.verbose('Storing instance of module', p), (h = p), a.data(l, p)
              },
              destroy: function () {
                p.verbose('Destroying previous instance'),
                  ...
                  e && e.disconnect(),
                  t && t.disconnect(),
                  f.off('load' + c, p.event.load).off('resize' + c, p.event.resize),
                  u.off('scrollchange' + c, p.event.scrollchange),
                  a.removeData(l)
              },
              observeChanges: function () {
                'MutationObserver' in w &&
                  ((e = new MutationObserver(p.event.documentChanged)),
                  (t = new MutationObserver(p.event.changed)),
                  e.observe(B, { childList: !0, subtree: !0 }),
                  t.observe(g, { childList: !0, subtree: !0 }),
                  t.observe(i[0], { childList: !0, subtree: !0 }),
                  p.debug('Setting up mutation observer', t))
              },
              determineContainer: function () {
                n = m.container ? T(m.container) : a.offsetParent()
              },
              determineContext: function () {
                0 !== (i = m.context ? T(m.context) : n).length ||
                  p.error(r.invalidContext, m.context, a)
              },
              checkErrors: function () {
                if (
                  (p.is.hidden() && p.error(r.visible, a),
                  p.cache.element.height > p.cache.context.height)
                )
                  return p.reset(), void p.error(r.elementSize, a)
              },
              bind: {
                events: function () {
                  f.on('load' + c, p.event.load).on('resize' + c, p.event.resize),
                    u
                      .off('scroll' + c)
                      .on('scroll' + c, p.event.scroll)
                      .on('scrollchange' + c, p.event.scrollchange)
                },
              },
              event: {
                changed: function (e) {
                  ...
                  ;[].forEach.call(e, function (e) {
                    e.removedNodes &&
                      [].forEach.call(e.removedNodes, function (e) {
                        ;(e == g || 0 < T(e).find(g).length) &&
                          (p.debug('Element removed from DOM, tearing down events'), p.destroy())
                      })
                  })
                },
                load: function () {
                ...
                scrollchange: function (e, t) {
                  p.stick(t), m.onScroll.call(g)
                },
              },
              refresh: function (e) {
                p.reset(),
                  m.context || p.determineContext(),
                  e && p.determineContainer(),
                  p.save.positions(),
                  p.stick(),
                  m.onReposition.call(g)
              },
              supports: {
                sticky: function () {
                  var e = T('<div/>')
              ...
              save: {
                ...
                positions: function () {
                  var e = { height: u.height() },
                    ...
                    o = { offset: i.offset(), height: i.outerHeight() }
                  n.outerHeight()
                  p.is.standardScroll() ||
                    (p.debug('Non-standard scroll. Removing scroll offset from element offset'),
                    (e.top = u.scrollTop()),
                    (e.left = u.scrollLeft()),
                    (t.offset.top += e.top),
                    (o.offset.top += e.top),
                    ...
                    (p.cache = {
                      fits: t.height + m.offset <= e.height,
              ...
              get: {
                ...
                currentElementScroll: function () {
                  return p.elementScroll
                    ? p.elementScroll
                    : p.is.top()
                      ? Math.abs(parseInt(a.css('top'), 10)) || 0
                      : Math.abs(parseInt(a.css('bottom'), 10)) || 0
                },
                elementScroll: function (e) {
                  e = e || u.scrollTop()
                  var t = p.cache.element,
                    ...
                    i = t.height - o.height + m.offset,
                    s = p.get.currentElementScroll(),
                    r = s + n
                  return (s = p.cache.fits || r < 0 ? 0 : i < r ? i : r)
                },
              },
              remove: {
                lastScroll: function () {
              ...
              set: {
                offset: function () {
                  p.verbose('Setting offset on element', m.offset), a.css('margin-top', m.offset)
                },
                containerSize: function () {
                  ...
                  'HTML' === t || 'body' == t
                    ? p.determineContainer()
                    : ((e = Math.max(p.cache.context.height, p.cache.element.height)) -
                        n.outerHeight() >
                      m.jitter
                        ? (p.debug(
                          ...
                          n.css({ height: e }))
                        : n.css({ height: '' }),
                      Math.abs(n.outerHeight() - p.cache.context.height) > m.jitter &&
                        (p.debug(
                          'Context has padding, specifying exact height for container',
                          p.cache.context.height
                        ),
                        n.css({ height: p.cache.context.height })))
                },
                minimumSize: function () {
                ...
                scroll: function (e) {
                  p.debug('Setting scroll on element', e),
                    p.elementScroll != e &&
                      (p.is.top() && a.css('bottom', '').css('top', -e),
                      p.is.bottom() && a.css('top', '').css('bottom', e))
                },
                size: function () {
                  0 !== p.cache.element.height &&
                    0 !== p.cache.element.width &&
                    (g.style.setProperty('width', p.cache.element.width + 'px', 'important'),
                    g.style.setProperty('height', p.cache.element.height + 'px', 'important'))
                },
              },
              is: {
              ...
              stick: function (e) {
                var t = e || u.scrollTop(),
                  ...
                  r = o.scrollContext,
                  c = o.context,
                  l = p.is.bottom() && m.pushing ? m.bottomOffset : m.offset,
                  e = { top: t + l, bottom: t + l + r.height },
                  a = (p.get.direction(e.top), n ? 0 : p.get.elementScroll(e.top)),
                  f = !n
                0 === s.height ||
                  i ||
                  (p.is.initialPosition()
                    ? e.top >= c.bottom
                      ? (p.debug('Initial element position is bottom of container'), p.bindBottom())
                      : e.top > s.top &&
                        (s.height + e.top - a >= c.bottom && s.height < c.height
                    ...
                    : p.is.fixed()
                      ? p.is.top()
                        ? e.top <= s.top
                          ...
                          : s.height + e.top - a >= c.bottom
                            ? (p.debug('Fixed element reached bottom of container'), p.bindBottom())
                            : f &&
                              (p.set.scroll(a), p.save.lastScroll(e.top), p.save.elementScroll(a))
                        : p.is.bottom() &&
                          (e.bottom - s.height <= s.top
              ...
              bindTop: function () {
                p.debug('Binding element to top of parent container'),
                  p.remove.offset(),
                  m.setSize && p.set.size(),
                  a
                    .css({ left: '', top: '', marginBottom: '' })
                    .removeClass(o.fixed)
                    .removeClass(o.bottom)
                    .addClass(o.bound)
                    .addClass(o.top),
                  m.onTop.call(g),
                  m.onUnstick.call(g)
              ...
              fixTop: function () {
                p.debug('Fixing element to top of page'),
                  ...
                  p.set.offset(),
                  a
                    .css({ left: p.cache.element.left, bottom: '', marginBottom: '' })
                    .removeClass(o.bound)
                    .removeClass(o.bottom)
                    .addClass(o.fixed)
                    .addClass(o.top),
              ...
              unbind: function () {
                p.is.bound() &&
                  ...
                  p.remove.offset(),
                  a.removeClass(o.bound).removeClass(o.top).removeClass(o.bottom))
              },
              unfix: function () {
                p.is.fixed() &&
                  ...
                  p.remove.offset(),
                  a.removeClass(o.fixed).removeClass(o.top).removeClass(o.bottom),
                  m.onUnstick.call(g))
              },
              reset: function () {
              ...
              resetCSS: function () {
                a.css({ width: '', height: '' }), n.css({ height: '' })
              },
              ...
              error: function () {
                m.silent ||
                  ((p.error = Function.prototype.bind.call(console.error, console, m.name + ':')),
              ...
              invoke: function (n, e, t) {
                ...
                return (
                  ...
                  T.isFunction(s) ? (o = s.apply(t, e)) : s !== P && (o = s),
                  T.isArray(v) ? v.push(o) : v !== P ? (v = [v, o]) : o !== P && (v = o),
                  s
                )
              },
            }
          k
            ? (h === P && p.initialize(), p.invoke(y))
            : (h !== P && h.invoke('destroy'), p.initialize())
        }),
        v !== P ? v : this
      )
    }),
