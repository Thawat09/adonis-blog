      ...
      return (
        e.each(function () {
          var i,
            ...
            S = {
              initialize: function () {
                S.verbose('Initializing dimmer', v),
                  S.create.id(),
                  S.create.dimmer(),
                  S.refreshModals(),
                  S.bind.events(),
                  c.observeChanges && S.observeChanges(),
                  S.instantiate()
              },
              ...
              create: {
                dimmer: function () {
                  var e = {
                    ...
                    n = j.extend(!0, e, c.dimmerSettings)
                  j.fn.dimmer !== N
                    ? (S.debug('Creating dimmer'),
                      (o = v.dimmer(n)),
                      c.detachable
                        ? (S.verbose('Modal is detachable, moving content into dimmer'),
                ...
                id: function () {
                  ;(r = (Math.random().toString(16) + '000000000').substr(2, 8)),
                    (n = '.' + r),
                    S.verbose('Creating unique id for element', r)
                },
              },
              destroy: function () {
                s && s.disconnect(),
                  S.verbose('Destroying previous modal'),
                  h.removeData(g).off(f),
                  F.off(n),
                  a.off(n),
                  b.off(f),
                  v.dimmer('destroy')
              ...
              attachEvents: function (e, n) {
                var i = j(e)
                ;(n = j.isFunction(S[n]) ? S[n] : S.toggle),
                  0 < i.length
                    ? (S.debug('Attaching modal events to element', e, n),
                      i.off(f).on('click' + f, n))
                    : S.error(m.notFound, e)
              },
              bind: {
                events: function () {
                  S.verbose('Attaching events'),
                    h
                      .on('click' + f, l.close, S.event.close)
                      .on('click' + f, l.approve, S.event.approve)
                      .on('click' + f, l.deny, S.event.deny),
                    F.on('resize' + n, S.event.resize)
                },
                scrollLock: function () {
                  o.get(0).addEventListener('touchmove', S.event.preventScroll, { passive: !1 })
                },
              },
              unbind: {
                scrollLock: function () {
                  o.get(0).removeEventListener('touchmove', S.event.preventScroll, { passive: !1 })
                },
              },
              get: {
                id: function () {
              ...
              event: {
                approve: function () {
                  k || !1 === c.onApprove.call(p, j(this))
                    ? S.verbose('Approve callback returned false cancelling hide')
                    : ((k = !0),
                      S.hide(function () {
                        k = !1
                      }))
                ...
                deny: function () {
                  k || !1 === c.onDeny.call(p, j(this))
                    ? S.verbose('Deny callback returned false cancelling hide')
                    : ((k = !0),
                      S.hide(function () {
                        k = !1
                      }))
                ...
                click: function (e) {
                  var n, i
                  c.closable
                    ? ((n = 0 < j(e.target).closest(l.modal).length),
                      ...
                      !n &&
                        ...
                        S.remove.clickaway(),
                        c.allowMultiple ? S.hide() : S.hideAll()))
                    : S.verbose('Dimmer clicked but closable setting is disabled')
                },
                ...
                keyboard: function (e) {
                  27 == e.which &&
                    (c.closable
                      ...
                      : S.debug('Escape key pressed, but closable is set to false'),
                    e.preventDefault())
                },
                resize: function () {
                  ...
                  S.is.animating() || !S.is.active()
                    ? (S.showDimmer(),
                      ...
                      S.can.useFlex()
                        ...
                        : (S.set.legacy(),
                          S.set.modalOffset(),
                          S.debug('Using non-flex legacy modal positioning.')),
                      S.set.screenHeight(),
                      S.set.type(),
                      S.set.clickaway(),
                      !c.allowMultiple && S.others.active()
                        ? S.hideOthers(S.showModal)
                        : (c.allowMultiple && c.detachable && h.detach().appendTo(a),
                          c.onShow.call(p),
                          c.transition && j.fn.transition !== N && h.transition('is supported')
                            ? (S.debug('Showing modal with css animations'),
                              h.transition({
                                ...
                                onComplete: function () {
                                  c.onVisible.apply(p),
                                    c.keyboardShortcuts && S.add.keyboardShortcuts(),
                                    S.save.focus(),
                                    S.set.active(),
                                    c.autofocus && S.set.autofocus(),
                                    e()
                                },
                              }))
                  ...
                  !1 !== c.onHide.call(p, j(this))
                    ? (S.is.animating() || S.is.active()) &&
                      (c.transition && j.fn.transition !== N && h.transition('is supported')
                          ...
                          h.transition({
                            ...
                            onStart: function () {
                              S.others.active() || n || S.hideDimmer(),
                                c.keyboardShortcuts && S.remove.keyboardShortcuts()
                            },
                            onComplete: function () {
                        ...
                        : S.error(m.noTransition))
                    : S.verbose('Hide callback returned false cancelling hide')
              },
              showDimmer: function () {
                o.dimmer('is animating') || !o.dimmer('is active')
                  ? (S.debug('Showing dimmer'), o.dimmer('show'))
              ...
              hideAll: function (e) {
                ...
                ;(e = j.isFunction(e) ? e : function () {}),
                  0 < n.length &&
                    (S.debug('Hiding all visible modals'), S.hideDimmer(), n.modal('hide modal', e))
              },
              hideOthers: function (e) {
                var n = t.filter('.' + d.active + ', .' + d.animating)
                ;(e = j.isFunction(e) ? e : function () {}),
                  0 < n.length && (S.debug('Hiding other modals', t), n.modal('hide modal', e, !0))
              },
              others: {
                active: function () {
              ...
              remove: {
                ...
                bodyStyle: function () {
                  '' === x.attr('style') &&
                    (S.verbose('Removing style attribute'), x.removeAttr('style'))
                },
              ...
              cacheSizes: function () {
                ...
                ;(S.cache !== N && 0 === i) ||
                  ((S.cache = {
                    ...
                    contextHeight: 'body' == c.context ? j(q).height() : o.height(),
                  }),
                  (S.cache.topOffset = -S.cache.height / 2)),
              ...
              set: {
                ...
                dimmerSettings: function () {
                  ...
                  j.fn.dimmer !== N
                    ? ((e = {
                      ...
                      (n = j.extend(!0, e, c.dimmerSettings)),
                      c.inverted &&
                        (n.variation = n.variation !== N ? n.variation + ' inverted' : 'inverted'),
                      v.dimmer('setting', n))
                    : S.error(m.dimmer)
                },
                dimmerStyles: function () {
                ...
                modalOffset: function () {
                  var e = S.cache.width,
                    n = S.cache.height
                  h.css({ marginTop: c.centered && S.can.fit() ? -n / 2 : 0, marginLeft: -e / 2 }),
                    S.verbose('Setting modal offset for legacy mode')
                },
                screenHeight: function () {
                  S.can.fit()
                    ? x.css('height', '')
                    : (S.debug('Modal is taller than page content, resizing page height'),
                      x.css('height', S.cache.height + 2 * c.padding))
                },
                active: function () {
                  h.addClass(d.active)
                },
                ...
                type: function () {
                  S.can.fit()
                    ? (S.verbose('Modal fits on screen'),
                      S.others.active() ||
                        S.others.animating() ||
                        (S.remove.scrolling(), S.bind.scrollLock()))
                    : (S.verbose('Modal cannot fit on screen setting to scrolling'),
                      S.set.scrolling())
                },
                undetached: function () {
              ...
              setting: function (e, n) {
                if ((S.debug('Changing setting', e, n), j.isPlainObject(e))) j.extend(!0, c, e)
                else {
                  if (n === N) return c[e]
              ...
              internal: function (e, n) {
                if (j.isPlainObject(e)) j.extend(!0, S, e)
                else {
                  if (n === N) return S[e]
                  S[e] = n
                }
              ...
              error: function () {
                c.silent ||
                  ((S.error = Function.prototype.bind.call(console.error, console, c.name + ':')),
              ...
              invoke: function (t, e, n) {
                ...
                return (
                  ...
                  j.isFunction(a) ? (i = a.apply(n, e)) : a !== N && (i = a),
                  j.isArray(C) ? C.push(i) : C !== N ? (C = [C, i]) : i !== N && (C = i),
                  a
                )
              },
            }
          T
            ? (y === N && S.initialize(), S.invoke(D))
            : (y !== N && y.invoke('destroy'), S.initialize())
        }),
        C !== N ? C : this
      )
    }),
