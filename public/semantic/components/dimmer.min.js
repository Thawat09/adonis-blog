      ...
      return (
        v.each(function () {
          var a,
            i,
            r = x.isPlainObject(p)
              ? x.extend(!0, {}, x.fn.dimmer.settings, p)
              : x.extend({}, x.fn.dimmer.settings),
            n = r.selector,
            e = r.namespace,
            t = r.className,
            s = r.error,
            ...
            g = {
              preinitialize: function () {
                a = g.is.dimmer()
                  ...
                  : ((i = l),
                    g.has.dimmer()
                      ? r.dimmerName
                        ? i.find(n.dimmer).filter('.' + r.dimmerName)
                        : i.find(n.dimmer)
                      : g.create())
              },
              initialize: function () {
              ...
              bind: {
                events: function () {
                  'hover' == r.on
                    ? i.on('mouseenter' + o, g.show).on('mouseleave' + o, g.hide)
                    : 'click' == r.on && i.on(c + o, g.toggle),
                    g.is.page() && (g.debug('Setting as a page dimmer', i), g.set.pageDimmer()),
                    g.is.closable() &&
                      (g.verbose('Adding dimmer close event', a),
                      i.on(c + o, n.dimmer, g.event.click))
                },
              },
              unbind: {
                events: function () {
              ...
              event: {
                click: function (e) {
                  g.verbose('Determining if event occurred on dimmer', e),
                    (0 !== a.find(e.target).length && !x(e.target).is(n.content)) ||
                      (g.hide(), e.stopImmediatePropagation())
                },
              },
              addContent: function (e) {
                var i = x(e)
                g.debug('Add content to dimmer', i),
                  i.parent()[0] !== a[0] && i.detach().appendTo(a)
              },
              create: function () {
              ...
              show: function (e) {
                ;(e = x.isFunction(e) ? e : function () {}),
                  ...
                  (g.is.dimmed() && !g.is.animating()) || !g.is.enabled()
                    ...
                    : (g.animate.show(e), r.onShow.call(u), r.onChange.call(u))
              },
              hide: function (e) {
                ;(e = x.isFunction(e) ? e : function () {}),
              ...
              has: {
                dimmer: function () {
                  return r.dimmerName
                    ? 0 < l.find(n.dimmer).filter('.' + r.dimmerName).length
                    : 0 < l.find(n.dimmer).length
                },
              },
              is: {
                active: function () {
              ...
              set: {
                opacity: function (e) {
                  ...
                  ;(e = 0 === r.opacity ? 0 : r.opacity || e),
                    (i = t || o ? ((n[3] = e + ')'), n.join(',')) : 'rgba(0, 0, 0, ' + e + ')'),
              ...
              setting: function (e, i) {
                if ((g.debug('Changing setting', e, i), x.isPlainObject(e))) x.extend(!0, r, e)
                else {
                  if (i === T) return r[e]
                  ...
                  'string' == typeof t &&
                    ...
                    x.each(t, function (e, i) {
                      ...
                      if (x.isPlainObject(r[n]) && e != o) r = r[n]
                        ...
                        if (!x.isPlainObject(r[i]) || e == o)
                          return r[i] !== T ? (a = r[i]) : g.error(s.method, t), !1
                        r = r[i]
                      }
                    })),
          ...
          g.preinitialize(),
            w
              ? (f === T && g.initialize(), g.invoke(C))
              : (f !== T && f.invoke('destroy'), g.initialize())
        }),
        b !== T ? b : this
      )
    }),
