      ...
      return (
        e.each(function () {
          var s,
            ...
            l,
            c = D.isPlainObject(C)
              ? D.extend(!0, {}, D.fn.sidebar.settings, C)
            ...
            y = {
              initialize: function () {
                y.debug('Initializing sidebar', C),
                  y.create.id(),
                  (l = y.get.transitionEvent()),
                  c.delaySetup ? M(y.setup.layout) : y.setup.layout(),
                  M(function () {
                    y.setup.cache()
                  }),
                  y.instantiate()
              ...
              destroy: function () {
                y.verbose('Destroying previous module for', b),
                  b.off(u).removeData(f),
              ...
              event: {
                clickaway: function (e) {
                  var i = 0 < g.find(e.target).length || g.is(e.target),
                    n = h.is(e.target)
                  i && (y.verbose('User clicked on dimmed page'), y.hide()),
                    n && (y.verbose('User clicked on dimmable context (scaled out page)'), y.hide())
                },
                touch: function (e) {},
              ...
              bind: {
                clickaway: function () {
                  y.verbose('Adding clickaway events to context', h),
                    c.closable &&
                      h.on('click' + a, y.event.clickaway).on('touchend' + a, y.event.clickaway)
                },
                scrollLock: function () {
                  c.scrollLock &&
                    (y.debug('Disabling page scroll'), w.on('DOMMouseScroll' + a, y.event.scroll)),
                    y.verbose('Adding events to contain sidebar scroll'),
                    T.on('touchmove' + a, y.event.touch),
                    b.on('scroll' + u, y.event.containScroll)
                },
              },
              unbind: {
                clickaway: function () {
                  y.verbose('Removing clickaway events from context', h), h.off(a)
                },
                scrollLock: function () {
              ...
              add: {
                inlineCSS: function () {
                  var e,
                    i = y.cache.width || b.outerWidth(),
                    n = y.cache.height || b.outerHeight(),
                    t = y.is.rtl(),
                    o = y.get.direction(),
                    r = { left: i, right: -i, top: n, bottom: -n }
                  t && (y.verbose('RTL detected, flipping widths'), (r.left = -i), (r.right = i)),
                    (e = '<style>'),
                    'left' === o || 'right' === o
                      ? (y.debug('Adding CSS rules for animation distance', i),
                        (e +=
                          ' .ui.visible.' +
                          o +
                    ...
                    (s = D((e += '</style>')).appendTo(S)),
                    y.debug('Adding sizing css to head', s)
                },
              },
              refresh: function () {
              ...
              setup: {
                ...
                layout: function () {
                  0 === h.children(n.pusher).length &&
                    (y.debug('Adding wrapper element for sidebar'),
                    y.error(d.pusher),
                    (g = D('<div class="pusher" />')),
                    h.children().not(n.omitted).not(m).wrapAll(g),
                    y.refresh()),
                    (0 !== b.nextAll(n.pusher).length && b.nextAll(n.pusher)[0] === g[0]) ||
                      (y.debug('Moved sidebar to correct parent element'),
                      y.error(d.movedSidebar, v),
                      b.detach().prependTo(h),
                      y.refresh()),
                    y.clear.cache(),
                    y.set.pushable(),
                    y.set.direction()
              ...
              attachEvents: function (e, i) {
                var n = D(e)
                ;(i = D.isFunction(y[i]) ? y[i] : y.toggle),
                  0 < n.length
                    ? (y.debug('Attaching sidebar events to element', e, i), n.on('click' + u, i))
                    : y.error(d.notFound, e)
              },
              show: function (e) {
                if (((e = D.isFunction(e) ? e : function () {}), y.is.hidden())) {
                  if (
                    (y.refreshSidebars(),
                    c.overlay && (y.error(d.overlay), (c.transition = 'overlay')),
                    y.refresh(),
                    y.othersActive())
                  )
              ...
              othersAnimating: function () {
                return 0 < m.not(b).filter('.' + r.animating).length
              },
              othersVisible: function () {
                return 0 < m.not(b).filter('.' + r.visible).length
              },
              othersActive: function () {
                return y.othersVisible() || y.othersAnimating()
              },
              hideOthers: function (e) {
                var i = m.not(b).filter('.' + r.visible),
                  n = i.length,
                  t = 0
                ;(e = e || function () {}),
              ...
              pushPage: function (i) {
                var e,
                  ...
                  t,
                  o = y.get.transition(),
                  r = 'overlay' === o || y.othersActive() ? b : g
                ;(i = D.isFunction(i) ? i : function () {}),
                  ...
                  (t = function (e) {
                    e.target == r[0] &&
                      (r.off(l + a, t), y.remove.animating(), y.bind.scrollLock(), i.call(v))
                  }),
                  r.off(l + a),
                  r.on(l + a, t),
                  M(e),
                  c.dimPage && !y.othersVisible() && M(n)
              },
              pullPage: function (i) {
                var e,
                  n,
                ...
                ;(i = D.isFunction(i) ? i : function () {}),
                  ...
                  (e = function () {
                    y.set.transition(t),
                      y.set.animating(),
                      y.remove.visible(),
                      c.dimPage && !y.othersVisible() && g.removeClass(r.dimmed)
                  }),
                  (n = function (e) {
                    e.target == o[0] &&
                      (o.off(l + a, n),
                      ...
                      y.remove.transition(),
                      y.remove.inlineCSS(),
                      ('scale down' == t || (c.returnScroll && y.is.mobile())) && y.scrollBack(),
                      i.call(v))
                  }),
                  o.off(l + a),
                  o.on(l + a, n),
              ...
              set: {
                ...
                animating: function () {
                  b.addClass(r.animating)
                },
                transition: function (e) {
                  ;(e = e || y.get.transition()), b.addClass(e)
                },
                direction: function (e) {
                  ;(e = e || y.get.direction()), b.addClass(r[e])
                },
                visible: function () {
                  b.addClass(r.visible)
                },
                overlay: function () {
                  b.addClass(r.overlay)
                },
              },
              remove: {
                inlineCSS: function () {
                  y.debug('Removing inline css styles', s), s && 0 < s.length && s.remove()
                },
                ios: function () {
                  x.removeClass(r.ios)
                },
                pushed: function () {
                  h.removeClass(r.pushed)
                },
                pushable: function () {
                  h.removeClass(r.pushable)
                },
                active: function () {
                  b.removeClass(r.active)
                },
                animating: function () {
                  b.removeClass(r.animating)
                },
                transition: function (e) {
                  ;(e = e || y.get.transition()), b.removeClass(e)
                },
                direction: function (e) {
                  ;(e = e || y.get.direction()), b.removeClass(r[e])
                },
                visible: function () {
                  b.removeClass(r.visible)
                },
                overlay: function () {
                  b.removeClass(r.overlay)
                },
              },
              get: {
                direction: function () {
                  return b.hasClass(r.top)
                    ? r.top
                    : b.hasClass(r.right)
                      ? r.right
                      : b.hasClass(r.bottom)
                  ...
                  var e = y.get.direction(),
                    i = y.is.mobile()
                      ...
                      : 'auto' == c.transition
                        ...
                        : c.transition
                  return y.verbose('Determined transition', i), i
                },
              ...
              is: {
                ...
                animating: function () {
                  return h.hasClass(r.animating)
                },
                rtl: function () {
                  return (
                    y.cache.rtl === z && (y.cache.rtl = 'rtl' == b.css('direction')), y.cache.rtl
                  )
                },
              },
              setting: function (e, i) {
                if ((y.debug('Changing setting', e, i), D.isPlainObject(e))) D.extend(!0, c, e)
                else {
                  if (i === z) return c[e]
                  D.isPlainObject(c[e]) ? D.extend(!0, c[e], i) : (c[e] = i)
                }
              },
                  ...
                  'string' == typeof t &&
                    ...
                    D.each(t, function (e, i) {
                      ...
                      if (D.isPlainObject(s[n]) && e != o) s = s[n]
                        ...
                        if (!D.isPlainObject(s[i]) || e == o)
                          return s[i] !== z ? (r = s[i]) : y.error(d.method, t), !1
                        s = s[i]
                      }
                    })),
                  D.isFunction(r) ? (n = r.apply(i, e)) : r !== z && (n = r),
                  D.isArray(k) ? k.push(n) : k !== z ? (k = [k, n]) : n !== z && (k = n),
                  r
                )
              },
            }
          E
            ? (p === z && y.initialize(), y.invoke(P))
            : (p !== z && y.invoke('destroy'), y.initialize())
        }),
        k !== z ? k : this
      )
    }),
