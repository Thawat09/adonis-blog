          ...
          ;(n = {
            initialize: function () {
              n.verbose('Initializing module'),
                ...
                f.context && '' !== s
                  ? e(f.context)
                      .on(s, 'mouseenter' + p, n.change.text)
                      .on(s, 'mouseleave' + p, n.reset.text)
                      .on(s, 'click' + p, n.toggle.state)
                  : y
                      .on('mouseenter' + p, n.change.text)
                      .on('mouseleave' + p, n.reset.text)
                      .on('click' + p, n.toggle.state),
                n.instantiate()
            },
            ...
            add: {
              defaults: function () {
                ...
                e.each(f.defaults, function (t, o) {
                  n.is[t] !== a &&
                    n.is[t]() &&
                    (n.verbose('Adding default states', t, w), e.extend(f.states, o, i))
                })
              },
            },
            is: {
              ...
              state: function () {
                ...
                if (n.allows('active') && n.is.enabled()) {
                  if ((n.refresh(), e.fn.api !== a))
                    if (((t = y.api('get request')), y.api('was cancelled')))
            ...
            listenTo: function (t) {
              n.debug('API request detected, waiting for state signal', t),
                t &&
                  (m.loading && n.update.text(m.loading),
            ...
            change: {
              ...
              text: function () {
                n.is.textEnabled() &&
                  (n.is.disabled()
                    ? (n.verbose('Changing text to disabled text', m.hover),
                      n.update.text(m.disabled))
                    : n.is.active()
                      ? m.hover
                        ? (n.verbose('Changing text to hover text', m.hover),
                          n.update.text(m.hover))
                        : m.deactivate &&
                          (n.verbose('Changing text to deactivating text', m.deactivate),
                          n.update.text(m.deactivate))
                      : m.hover
                        ? (n.verbose('Changing text to hover text', m.hover),
                          n.update.text(m.hover))
                        : m.activate &&
                          (n.verbose('Changing text to activating text', m.activate),
                          n.update.text(m.activate)))
              },
            },
            activate: function () {
            ...
            deactivate: function () {
              f.deactivateTest.call(w) &&
                ...
                n.update.text(m.inactive),
                f.onDeactivate.call(w))
            },
            sync: function () {
              n.verbose('Syncing other buttons to current state'),
                n.is.active() ? o.not(y).state('activate') : o.not(y).state('deactivate')
            },
            get: {
              text: function () {
            ...
            reset: {
              text: function () {
                var e = m.active || y.data(g.storedText),
                  t = m.inactive || y.data(g.storedText)
                n.is.textEnabled() &&
                  (n.is.active() && e
                    ? (n.verbose('Resetting active text', e), n.update.text(e))
                    : t && (n.verbose('Resetting inactive text', e), n.update.text(t)))
              },
            },
            update: {
              text: function (e) {
                ...
                e && e !== t
                  ? (n.debug('Updating text', e),
                    f.selector.text
                      ? y.data(g.storedText, e).find(f.selector.text).text(e)
            ...
            debug: function () {
              !f.silent &&
                ...
                (f.performance
                  ...
                  : ((n.debug = Function.prototype.bind.call(console.info, console, f.name + ':')),
            ...
            error: function () {
              f.silent ||
                ((n.error = Function.prototype.bind.call(console.error, console, f.name + ':')),
                  ...
                  e.each(t, function (i, o) {
                    ...
                    if (e.isPlainObject(u[s]) && i != c) u = u[s]
                      ...
                      if (!e.isPlainObject(u[o]) || i == c)
                        return u[o] !== a ? ((r = u[o]), !1) : (n.error(v.method, t), !1)
                      u = u[o]
                    }
                  })),
                e.isFunction(r) ? (l = r.apply(s, o)) : r !== a && (l = r),
                e.isArray(i) ? i.push(l) : i !== a ? (i = [i, l]) : l !== a && (i = l),
                r
              )
            },
          }),
